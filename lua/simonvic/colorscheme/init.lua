...
function M.build_groups(palette)
	...
	local groups = {
		...
		Function                           = { fg = p.func },
		Type                               = { bg = "none", fg = p.type },
        TypeBuiltIn                        = { bg = "none", fg = p.type },
        ...
        netrwClassify                      = { fg = p.text_5 },
        netrwHelpCmd                       = { fg = p.text_5 },
        netrwPlain                         = { fg = p.text_5 },
        ModeMsg                            = { fg = p.keyword },
		------------------------------------------------------------------------ Scrollbar
